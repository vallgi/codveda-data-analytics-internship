...
## Dataset Used
Cleaned House Prediction Dataset
...
- Created a correlation heatmap to show relationships between numerical features
- Analyzed correlations between house value and other features
